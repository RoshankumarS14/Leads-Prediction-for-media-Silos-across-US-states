...
if st.session_state.predict_leads:
    ...
    with col_df:
        ...
        with col_result1:
            ...
            <tr><td style="text-align: left; border: none;">Overhead Funds:</td><td style="text-align: right; border: none;">{round(sum(input_budget)/float(campaigns_values[0])*100)}</td></tr>
            </table>
            </pre>
