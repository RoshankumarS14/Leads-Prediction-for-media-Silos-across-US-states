...
if st.session_state.predict_leads:
    ...
    df_html = df_html.replace('<table ','<table style="text-align:right; margin-bottom:40px; margin-top:50px; width:100%;" ')
    ...
    with col_df:
        ...
        with col_result1:
            ...
            <tr><td style="text-align: left; border: none;">Overhead Funds:</td><td style="text-align: right; border: none;">{round(sum(input_budget)/float(campaigns_values[0]))}</td></tr>
            </table>
            </pre>
