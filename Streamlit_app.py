...
if st.button("Predict"):
    ...
    <tr><td style="text-align: left; border: none;">Proximity:</td><td style="text-align: right; border: none;">{int(calculate_rating(input_budget))}</td></tr>
